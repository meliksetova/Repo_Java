...
public class Class13 {
    public static void DublicValues (List<String> words) {
    ...
    public static void DublicValues2 () {
    ...
    public static void MaxScore () {
        ...
        HashMap<String, Integer> MaxScores2 = new HashMap<> ();
        String studentmax = "";
        for (String name : userMap2.keySet ()) {
            if (userMap2.get (name) == maxScore) {
                studentmax = name;
                MaxScores2.put (studentmax,maxScore);
            }
        }
        System.out.println ("Students that scored maximum: " + MaxScores2);
    }
}
